...
void main() {
  ...
  group('WeatherView', () {
    ...
    testWidgets('triggers refreshWeather on pull to refresh', (tester) async {
      ...
      await tester.pumpAndSettle();
      verify(() => weatherCubit.refreshWeather().call(1));
    });

    testWidgets('triggers ferch on search pop', (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState());
      ...
      await tester.tap(find.byKey(const Key('searchPage_search_iconButon')));
      await tester.pumpAndSettle();
